...
export class InventoryService {
	...
	//Metodo para retornar todo los productos activos
	...
	addProduct(product): Observable<any>{
		...
		return this._http.post(this.url+"/crear-producto",newProduct , {headers: headers});
	}
	...
	updateProduct(product): Observable<any>{
		let headers = new HttpHeaders().set("Content-Type", "application/json");
		return this._http.put(this.url+"/editar-producto/"+product.id, product, {headers: headers});
	}
